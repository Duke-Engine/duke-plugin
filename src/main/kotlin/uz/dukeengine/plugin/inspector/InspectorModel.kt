...
object InspectorModels {
    private const val GROUP = "uz.dukeengine.core.data.Group"
    private const val MODULE_GROUP = "uz.dukeengine.core.module.ModuleGroup"
    ...
    private class Builder(file: DukeFile) {
        ...
        private fun cards(
            ...
            val noun = if (element.qualifiedName == "uz.dukeengine.core.module.ModuleData") "module" else (element.name ?: key).lowercase()
