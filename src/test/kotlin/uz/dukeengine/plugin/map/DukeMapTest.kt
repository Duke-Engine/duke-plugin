...
class DukeMapTest : LightJavaCodeInsightFixtureTestCase() {
    override fun setUp() {
        super.setUp()
        myFixture.addClass("package uz.dukeengine.core.data; public @interface Grid { String solid() default \"#\"; }")
        myFixture.addClass("package uz.dukeengine.core.data; public @interface Relief {}")
