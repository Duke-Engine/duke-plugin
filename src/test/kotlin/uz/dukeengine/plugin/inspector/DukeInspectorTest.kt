...
class DukeInspectorTest : LightJavaCodeInsightFixtureTestCase() {
    override fun setUp() {
        super.setUp()
        myFixture.addClass("package uz.dukeengine.core.data; public @interface Group { String value(); }")
        myFixture.addClass("package uz.dukeengine.core.data; public @interface Link { Class<? extends Record> value(); }")
        myFixture.addClass("package uz.dukeengine.core.data; public @interface Clip {}")
        myFixture.addClass("package uz.dukeengine.core.module; public @interface ModuleGroup { String[] value(); }")
        myFixture.addClass("package uz.dukeengine.core.module; public interface ModuleData {}")
        myFixture.addClass(
            """
        ...
        myFixture.addClass("package game; public record Moves(String name, @uz.dukeengine.core.data.Clip String walk) {}")
        myFixture.addClass(
            """
            package game;
